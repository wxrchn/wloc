...
**Surge:**
https://raw.githubusercontent.com/wxrchn/wloc/refs/heads/main/modules/wloc.sgmodule

**Quantumult X:**
https://raw.githubusercontent.com/wxrchn/wloc/refs/heads/main/modules/wloc.conf

**Loon:**
https://raw.githubusercontent.com/wxrchn/wloc/refs/heads/main/modules/wloc.lpx

**Stash:**
https://raw.githubusercontent.com/wxrchn/wloc/refs/heads/main/modules/wloc.stoverride

**Shadowrocket(小火箭):**
https://raw.githubusercontent.com/wxrchn/wloc/refs/heads/main/modules/wloc.module
...
为了让苹果地图和高德走同一条流程，链接统一发给 `wloc.fweb.workers.dev/api/parse` 解析：
...
- 部署后把快捷指令里的 `wloc.fweb.workers.dev` 换成你自己的 worker 域名即可。
...
- **Workers**: `https://wloc.fweb.workers.dev/`
- **Pages**: `https://wloc-pages.pages.dev/`

**一键部署（Workers）：**

[![Deploy to Cloudflare Workers](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/wxrchn/wloc/tree/main/worker)
...
```bash
# 1. 克隆仓库
git clone https://github.com/wxrchn/wloc.git
cd wloc/worker
